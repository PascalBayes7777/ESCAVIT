...
class LeadAttention3D(nn.Module):
    def __init__(self, output_dim):
        ...
        self.resnet3d.stem[0] = nn.Conv3d(1, 64, kernel_size=(3, 7, 7), 
                                         ...
                                         bias=False)
        self.spatial_attention = Spatial3DAttention()
...
class PairwiseLeadAttention3D(nn.Module):
    def __init__(self, output_dim):
        ...
        self.spatial_attention1 = Spatial3DAttention()
        self.spatial_attention2 = Spatial3DAttention()
    ...
    def forward(self, x):
        ...
        pair1 = self.spatial_attention1(pair1)
        pair2 = self.spatial_attention2(pair2)
